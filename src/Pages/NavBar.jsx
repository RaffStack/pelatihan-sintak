    ...
    <>
      <div className="navbar bg-base-100 shadow-sm">
        <div className="navbar-start">
          ...
          <Link className="btn btn-ghost text-xl "><BiCoffee className="text-amber-800 text-2xl"/>Aroma Sriwijaya</Link>
        </div>
        ...
        <div className="navbar-end ">
          ...
          <Link className="btn bg-amber-800 text-white mr-6">Contact Us</Link>
        </div>
